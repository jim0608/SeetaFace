...
/**
 * 打开两个相机的辅助类，和{@link com.mysafe.lib_identification.camera.ICameraListener}共同使用，获取nv21数据等操作
 * <p>
...
public class DualCameraHelper implements Camera.PreviewCallback {
    ...
    private static final String TAG = "TAGCameraHelper";
    ...
    //region SurfaceView和TextureView的监听器
...
//endregion
    ...
    public static final class Builder {
        ...
        public Builder cameraListener(ICameraListener val) {
            cameraListener = val;
            return this;
        }
